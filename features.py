...
class features:
	...
	def __init__(self):
		...
		self.f = []
		self.feature_table = [1 for x in xrange(673680)]
		self.origin_x = 0
		self.origin_y = 0
	...
	def typeI(self, integral_image, x, y, w, h):
		...
		return (sumD-sumU)/self.patch_std
	...
	def typeII(self, integral_image, x, y, w, h):
		...
		return (sumL-sumR)/self.patch_std
	...
	def typeIII(self, integral_image, x, y, w, h):
		...
		return (sumL-sumC+sumR-self.patch_mean*w*h)/self.patch_std
	...
	def typeIV(self, integral_image, x, y, w, h):
		...
		return (-sumLD+sumRD+sumLU-sumRU)/self.patch_std
